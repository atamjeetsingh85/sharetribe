...
import { checkCompanyname } from '../../../ducks/auth.duck'; // Import Redux thunk
...
import { validateCompanyName } from '../../../util/validators'; 
...
const SignupFormComponent = props => {
  ...
  const intl = useIntl();
  const [companyAvailable, setCompanyAvailable] = useState(null);
  const [checkingCompany, setCheckingCompany] = useState(false);

  console.log(checkingCompany, "checking Company Available");
  return(
    <FinalForm
      {...props}
      ...
      render={formRenderProps => {
        ...
        const companyNameInvalidMessage = intl.formatMessage({
          id: 'SignupForm.companyNameInvalid',
        });
        
        const companyNameCheckErrorMessage = intl.formatMessage({
          id: 'SignupForm.companyNameError',
        });
